    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">TaufaBazar</h1>
          <h2 className="text-xl font-semibold text-gray-600">Admin Dashboard</h2>
        </div>
      </div>
          ...
          {error && (
            <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-md">
              <p className="text-sm text-red-800">
                <strong>Access Denied:</strong> You are not authorized to access the admin dashboard. 
